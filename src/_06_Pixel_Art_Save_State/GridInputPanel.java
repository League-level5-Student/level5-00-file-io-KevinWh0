...
public class GridInputPanel extends JPanel{
	...
	private void load() {
		try (FileInputStream fis = new FileInputStream(new File("src/_06_Pixel_Art_Save_State/saved.dat")); ObjectInputStream ois = new ObjectInputStream(fis)) {
	...
	public static void save(Object data) {
		try (FileOutputStream fos = new FileOutputStream(new File("src/_06_Pixel_Art_Save_State/saved.dat")); ObjectOutputStream oos = new ObjectOutputStream(fos)) {
